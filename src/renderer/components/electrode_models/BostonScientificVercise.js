...
function BostonScientificVercise(props, ref) {
  // console.log('bc name=', props.name);
  const svgs = [
    <HeadTop key="headTop" />,
    // <HeadBottom key="headBottom" />,
    <Contact key="8" level="8" />,
    <Contact key="7" level="7" face="all" />,
    <Contact key="6" level="6" face="all" />,
    <Contact key="5" level="5" face="all" />,
    <Contact key="4" level="4" face="all" />,
    <Contact key="3" level="3" face="all" />,
    <Contact key="2" level="2" face="all" />,
    <Tail key="1" level="1" face="all" />,
    // <Tail key="bottom" fill="transparent" />,
  ];
        ...
        <div className="IPG">
          {ipgs.map((ipg) => (
            <div className="image-item">
              ...
              {/* <p className="image-name-boston">{names[Lcon.key]}</p> */}
            </div>
          ))}
        </div>
      </div>
      <div className="Elmodel-center-medtronic3389">
        {svgs.map((svg) => (
          <div
...
export default forwardRef(BostonScientificVercise);
