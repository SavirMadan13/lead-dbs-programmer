...
function Generic_elmodel(props, ref) {
  ...
  const [templateSpace, setTemplateSpace] = useState(props.templateSpace || 0);
  ...
  return (
    <div className="container">
      ...
      <div style={elspec.isdirected === 0 ? { paddingLeft: '80px' } : {}}>
        {handleIPG()}
        {radioValue === '2' &&
